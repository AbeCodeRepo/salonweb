...
<section class="messages">
   ...
   <?php
      $select_message = mysqli_query($conn, "SELECT * FROM `appointment`") or die('query failed');
   ...
   <div class="box">
      ...
      <a href="admin_appointment.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('delete this message?');" class="delete-btn">delete message</a>
   </div>
   <?php
      };
   }else{
